...
<!DOCTYPE html>
<html class="${properties.kcHtmlClass!}" lang="en"<#if realm.internationalizationEnabled> dir="${(locale.rtl)?then('rtl','ltr')}"</#if>>
...
<div class="${properties.kcLoginClass!}">
    ...
    <div class="${properties.kcFormCardClass!}">
        <header id="kc-header" class="pf-v5-c-login__header ${properties.kcFormHeaderClass!}">
            <div id="kc-header-wrapper"
                class="pf-v5-c-brand">
